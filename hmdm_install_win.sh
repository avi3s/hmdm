...
TOMCAT_HOME=$(ls -d "C:\\Program Files\\Apache Software Foundation\\Tomcat 8.5\\*" | tail -n1)
...
if [ "$TOMCAT_HOME" == "C:\\Program Files\\Apache Software Foundation\\Tomcat 9.0" ]; then
    DEFAULT_LOCATION="C:\\Program Files\\Apache Software Foundation\\Tomcat 9.0\\work"
fi
...
echo "http://$BASE_DOMAIN:9080$BASE_PATH"
