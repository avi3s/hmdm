 ...
 * @author isv
 */
public class DeviceLocationsPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>DeviceLocationsPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public DeviceLocationsPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.devicelocations.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.devicelocations.persistence.domain";
    }
