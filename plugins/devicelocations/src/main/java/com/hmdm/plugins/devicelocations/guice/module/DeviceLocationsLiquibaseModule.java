...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Device Locations</code>
 * plugin.</p>
 *
 * @author isv
 */
public class DeviceLocationsLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>DeviceLocationsLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public DeviceLocationsLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/devicelocations.changelog.xml").getPath();
