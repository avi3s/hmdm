...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>OpenVPN</code>
 * plugin.</p>
 *
 * @author isv
 */
public class OpenVPNLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>OpenVPNLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public OpenVPNLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/openvpn.changelog.xml").getPath();
