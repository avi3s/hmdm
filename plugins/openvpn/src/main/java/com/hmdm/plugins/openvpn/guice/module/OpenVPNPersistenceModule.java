 ...
 * @author isv
 */
public class OpenVPNPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>OpenVPNPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public OpenVPNPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.openvpn.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.openvpn.persistence.domain";
    }
}
