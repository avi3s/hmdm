...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Device Reset</code>
 * plugin.</p>
 *
 * @author isv
 */
public class DeviceResetLiquibaseModule extends AbstractLiquibaseModule {
    ...
    /**
     * <p>Constructs new <code>DeviceResetLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
