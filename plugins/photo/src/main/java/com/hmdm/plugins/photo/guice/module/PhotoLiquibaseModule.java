...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Photo</code> plugin.
 * </p>
 *
 * @author isv
 */
public class PhotoLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>PhotoLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public PhotoLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/photo.changelog.xml").getPath();
