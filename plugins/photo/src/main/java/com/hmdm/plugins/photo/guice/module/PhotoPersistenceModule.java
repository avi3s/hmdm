 ...
 * @author isv
 */
public class PhotoPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>PhotoPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public PhotoPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.photo.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.photo.persistence.domain";
    }
}
