...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Device Export</code>
 * plugin.</p>
 *
 * @author isv
 */
public class DeviceExportLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>DeviceExportLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public DeviceExportLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/deviceexport.changelog.xml").getPath();
