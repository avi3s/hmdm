...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Device Import</code>
 * plugin.</p>
 *
 * @author isv
 */
public class DeviceImportLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>DeviceImportLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public DeviceImportLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/deviceimport.changelog.xml").getPath();
