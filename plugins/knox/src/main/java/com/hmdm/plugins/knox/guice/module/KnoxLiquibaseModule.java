...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Knox</code>
 * plugin.</p>
 *
 * @author isv
 */
public class KnoxLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>KnoxLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public KnoxLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/knox.changelog.xml").getPath();
