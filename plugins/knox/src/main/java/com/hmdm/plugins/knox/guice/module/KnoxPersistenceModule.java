 ...
 * @author isv
 */
public class KnoxPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>KnoxPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public KnoxPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.knox.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.knox.persistence.domain";
    }
