...
import com.hmdm.plugins.knox.rest.KnoxResource;
...
/**
 * <p>A <code>Guice</code> module for <code>Knox Plugin</code> REST resources.</p>
 *
 * @author isv
 */
public class KnoxRestModule extends ServletModule {
    ...
    private static final List<String> protectedResources = Arrays.asList(
            "/rest/plugins/knox/private/*"
    );

    /**
     * <p>Constructs new <code>KnoxRestModule</code> instance. This implementation does nothing.</p>
     */
    public KnoxRestModule() {
    }

    /**
     * <p>Configures the <code>Knox Plugin</code> REST resources.</p>
     */
