...
angular.module('headwind-kiosk')
    .controller('MandalController', function ($scope, $rootScope, $state, $stateParams, $modal, $interval, $cookies, $window, $filter, $timeout,
        ...
        $scope.getDashboardData = function (report_months){
            ...
            dashboardService.getMandalData(request,function (response) {
