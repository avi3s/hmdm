...
document.localization ['en_US'] = {
    ...
    'app.name': 'RBK MDM',
    'app.description': 'is the Enterprise grade mobile device management system',
    'app.title': 'RBK MDM Web Panel',
    ...
    'about.line.1': 'RBK MDM control panel',
    ...
    'qrcode.help.line5': 'The QR code may contain the device ID for RBK MDM (so you don\'t need to enter it on a mobile device). To embed the device ID into the QR code, enter the device ID on this screen and click "Renew".',
    ...
    'ie.browser.notice.2': 'Recommended Browser for Using RBK MDM - <a href="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop">Chrome</a>.',
